...
def parse_args():
    ...
    parser.add_argument('--img_size', type=int, default=256, help='The size of image') # here you can pass 128 or 512 sizes
...
def main():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        if args.phase == 'train' :
            ...
            gan.visualize_results50(args.epoch == 50)
            gan.visualize_results100(args.epoch == 100)
            gan.visualize_results200(args.epoch == 200)
