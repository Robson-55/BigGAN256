...
class BigGAN_256(object):
    ...
    def visualize_results50(self, epoch):
        tot_num_samples = 4
        image_frame_dim = 4
        ...
        save_images(samples[:image_frame_dim * image_frame_dim, :, :, :], [image_frame_dim, image_frame_dim],
                    self.sample_dir + '/' + self.model_name + '_epoch%02d' % epoch + '_visualize50.png')

    def visualize_results100(self, epoch):
        tot_num_samples = 8
        image_frame_dim = 8
        ...
        save_images(samples[:image_frame_dim * image_frame_dim, :, :, :], [image_frame_dim, image_frame_dim],
                    self.sample_dir + '/' + self.model_name + '_epoch%02d' % epoch + '_visualize100.png')

    def visualize_results200(self, epoch):
        tot_num_samples = 1
        image_frame_dim = 1
        ...
        save_images(samples[:image_frame_dim * image_frame_dim, :, :, :], [image_frame_dim, image_frame_dim],
                    self.sample_dir + '/' + self.model_name + '_epoch%02d' % epoch + '_visualize200.png')        
